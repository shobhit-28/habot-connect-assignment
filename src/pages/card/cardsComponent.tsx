...
export const CardsComponent: React.FC<CardsComponentProps> = ({ learningCentre }) => {
    ...
    return (
        <div title={learningCentre.name} className='w-[280px] bg-white rounded-2xl shadow-[0px_3px_10px_rgba(0,0,0,0.15)] hover:shadow-[0px_8px_20px_rgba(0,0,0,0.3)] duration-500 cursor-pointer overflow-hidden flex flex-col' onClick={() => nav(`/institute/${learningCentre.name}`)}>
